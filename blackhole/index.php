...
define('BLACKHOLE_TO',      'abuse@chris-webserver.de'); // email to
define('BLACKHOLE_FROM',    'abuse@chris-webserver.de'); // email from
define('BLACKHOLE_ADMIN',   'abuse (a) chris-webserver . de'); // shown when banned
...
function blackhole_get_vars() {
	...
	if (isset($_SERVER['REQUEST_SCHEME'])) $request = $_SERVER['REQUEST_SCHEME'] . "://";
	if (isset($_SERVER['SERVER_NAME'])) $request .= $_SERVER['SERVER_NAME'];
...
function blackhole_checkbot($ip, $ua, $request) {
	...
	$fp = fopen($filename, 'r') or die('<p>Error: Can\'t open Data File</p>');
...
function blackhole() {
	...
	if ($badbot > 0) {
		...
		<p>If you think there has been a mistake, email &quot;<em><?php echo BLACKHOLE_ADMIN; ?></em>&quot;.</p>
...
<html lang="en-US">
	<head>
		<title>Welcome to the black hole!</title>
		<link rel="stylesheet" href="style.css" type="text/css">
	</head>
	<body>
		<div id="blackhole">
			<h1>You have fallen into a black hole!</h1>
			<p>
			...
			<p>
				If you think there has been a mistake, email &quot;<em><?php echo BLACKHOLE_ADMIN; ?></em>&quot;.
			</p>
